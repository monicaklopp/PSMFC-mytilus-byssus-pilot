...
getwd()
setwd("measurements/20211026_T0")
...
write.xlsx(x=dat_nested$ID_sort, file="constraints_20211026_T0.xlsx", sheetName = "20211026_T0", col.names = TRUE, row.names = TRUE, append = FALSE)


# Plot the lines one by one to find ones to trash. Add start and stop to for recalcs in constraints tab of MR_output.

getwd(); setwd('..'); setwd('QC_plots/20211026_T0'); getwd()
...
constraints <- read_excel("constraints_20211026_T0.xlsx", sheet = "20211026_T0", col_names = TRUE)
